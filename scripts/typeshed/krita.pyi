...
class SliderSpinBox(QObject):
    draggingFinished = pyqtSignal()
    def __init__(self) -> None: ...
    def widget(self) -> QSpinBox: ...
    def setRange(self, min: int, max: int, compute_fast_step: bool=True) -> None: ...
    def setMinimum(self, value: int, compute_fast_step: bool=True) -> None: ...
    def setMaximum(self, value: int, compute_fast_step: bool=True) -> None: ...
    def setValue(self, value: int) -> None: ...
    def setExponentRatio(self, value: float) -> None: ...
    def setBlockUpdateSignalOnDrag(self, block: bool) -> None: ...
    def fastSliderStep(self) -> int: ...
    def setFastSliderStep(self, value: int) -> None: ...
    def setSoftRange(self, min: int, max: int) -> None: ...
    def softMinimum(self) -> int: ...
    def setSoftMinimum(self, value: int) -> None: ...
    def softMaximum(self) -> int: ...
    def setSoftMaximum(self, value: int) -> None: ...
